...
add wave  -group settings -radix dec  /top_tb/dut/base_addr_i
add wave  -group settings -radix dec  /top_tb/dut/length_i
add wave  -group settings             /top_tb/dut/run_i
add wave  -group settings             /top_tb/dut/waitrequest_o

# reader
add wave  -divider "Reader signals"
add wave  -group reader   -radix dec  /top_tb/dut/amm_rd_address_o
...
add wave  -group writer   -radix dec  /top_tb/dut/amm_wr_address_o
